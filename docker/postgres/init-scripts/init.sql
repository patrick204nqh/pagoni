...
--
-- Name: pagoni_local; Type: DATABASE; Schema: -; Owner: postgres
--
DROP DATABASE pagoni_local;

CREATE DATABASE pagoni_local WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';


ALTER DATABASE pagoni_local OWNER TO postgres;

\connect pagoni_local
